...
class Edge extends Widget
{
	...
	public function onConstruct()
	{
		...
		$this->quad = new Quad(12, 6);
		$this->quad->setPosY(-0.5);
		$this->quad->setPosX(21);
		$this->quad->setImage($config->getImage("ratiobutton", "normal_off.png"), true);
		...
		$this->sscript->setParam("imageOff", $config->getImage("ratiobutton", "normal_off.png"));
		$this->sscript->setParam("imageOn", $config->getImage("ratiobutton", "normal_on.png"));
