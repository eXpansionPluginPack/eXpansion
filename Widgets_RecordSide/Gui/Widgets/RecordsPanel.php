...
class RecordsPanel extends \ManiaLive\Gui\Window {
	...
	if ($pmanager->isLoaded('ManiaLivePlugins\\eXpansion\\Dedimania\\Dedimania') && $pmanager->isLoaded('ManiaLivePlugins\\eXpansion\\LocalRecords\\LocalRecords')) {
	...
	if ($pmanager->isLoaded('ManiaLivePlugins\\eXpansion\\LocalRecords\\LocalRecords')) {
