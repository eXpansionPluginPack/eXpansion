...
class Permission {
    ...
    const player_spec = 'player_spec';
    
    //concerning Server Settings
    const server_admin = 'server_admin';
    const server_dedistop = 'server_dedistop';
    const server_manialive = 'server_manialive';
