...
class Webaccess
{
    ...
    function request(
        $url, $callback, $datas, $is_xmlrpc = false, $keepalive_min_timeout = 300, $opentimeout = 3, $waittimeout = 5,
        $agent = 'XMLaccess', $mimeType = "text/html"
    )
    {
...
class WebaccessUrl
{
    ...
    function __construct(
        &$wa, $host, $port, $keepalive = true, $keepalive_timeout = 600, $keepalive_max = 300, $agent = 'XMLaccess',
        $mimeType = "text/html"
    )
    {
