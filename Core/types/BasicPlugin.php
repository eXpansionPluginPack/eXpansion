	...
	public static function exp_checkGameCompability(){
		...
		if(isset(self::$plugin_gameModeSupport[$class])){
			...
			if($gameInfo->gameMode == GameInfos::GAMEMODE_SCRIPT && is_array(self::$plugin_gameModeSupport[$class][$gameInfo->gameMode])){
				return isset(self::$plugin_gameModeSupport[$class][$gameInfo->gameMode][$gameInfo->scriptName])
						? self::$plugin_gameModeSupport[$class][$gameInfo->gameMode][$gameInfo->scriptName] : false;
			}else
				return isset(self::$plugin_gameModeSupport[$class][$gameInfo->gameMode])
						? self::$plugin_gameModeSupport[$class][$gameInfo->gameMode] : false;
