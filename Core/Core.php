...
EOT;
    ...
    public function onGameSettingsChange(
        ...
        \Maniaplanet\DedicatedServer\Structures\GameInfos $newSettings, $changes
    ) {
        $this->saveMatchSettings();
    }

    /**
     * When there is a script event. we handle those event to transform them to nicer event to handle
     *
     * @param string   $param1 to make simple, the name of the event
     * @param string[] $param2 The values returned
     */
     ...
     */
    protected function dispatchSciptEvent($event, $param)
    {
