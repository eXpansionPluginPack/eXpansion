...
class Config extends \ManiaLib\Utils\Singleton {
    ...
    public $Colors_admin_action = '$48c'; // admin actions color
    public $Colors_variable = '$fff'; // generic variable color
    
    public $Colors_record = '$8cf'; // all other local records
    public $Colors_record_top = '$9f0'; // top5 local records
    public $Colors_dedirecord = '$fc8'; // dedimania records            
    public $Colors_rank = '$ff0'; // used in record messages for rank    
    public $Colors_time = '$fff';
    
    public $Colors_rating = '$9f0'; // map ratings color
    public $Colors_queue = '$9f0';  // map queue messages
        
    public $Colors_personalmessage = '$3f0'; // personal messages
    public $Colors_admingroup_chat = '$6af'; // admin chat channel
    
    public $Colors_donate = '$0af'; // donate
    public $Colors_player = '$z$s$8cf';  // used in joinleave-messages
