...
class ConfElement extends \ManiaLive\Gui\Control {
	...
	$this->addComponent($this->bg);
        ...
        $this->button_save = new Button(25, 6);
        ...
        $this->button_load = new Button(25, 6);
        ...
        if(!$isCurrent){
            $this->button_select  = new Button(25, 6);
            $this->button_select ->setText(__('Load', $login));
	...
	$this->button_save->setPosition($this->getSizeX() - $this->button_save->getSizeX() + 5, 0);
	$this->button_load->setPosition($this->getSizeX() - $this->button_save->getSizeX()*2 + 4, 0);

	if ($this->button_select != null) {
            $this->button_select->setPosition($this->getSizeX() - $this->button_save->getSizeX()*3 + 3, 0);
	}
    }
