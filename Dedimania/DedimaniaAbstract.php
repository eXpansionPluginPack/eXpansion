 ...
 */
abstract class DedimaniaAbstract extends \ManiaLivePlugins\eXpansion\Core\types\ExpPlugin
    implements \ManiaLivePlugins\eXpansion\Dedimania\Events\Listener
{
        ...
        if (!$this->running) {
            if (empty($this->config->login) || empty($this->config->code)) {
                ...
                $admins->announceToPermission(
                    Permission::expansion_pluginSettings,
