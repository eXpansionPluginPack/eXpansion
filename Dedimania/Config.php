...
class Config extends \ManiaLib\Utils\Singleton {
    ...
    public $login = null;
    public $code = null;
    public $recordMsg = '%1$s#dedirecord# improved the #rank#%2$s#dedirecord#. Dedimania Record!  #rank#%2$s: #time#%3$s #dedirecord#(#rank#%4$s -#rank#%5$s#dedirecord#)'; // %1$s = nickname, %2$s = place, %3$s = time, %4$s = old place %5$s = difference 
