...
class Config extends \ManiaLib\Utils\Singleton
{
    ...
    public $bb = array("Bye", "Laters", "See ya later!", "Goodbye!", "Hasta la vista!", "Ciao!", "is out of here, bye!", "bye all!!");
    public $bb2 = array("Bye Bye", "Laters", "See ya later", "Goodbye", "Hasta la vista", "Ciao", "is out of here, bye", "hope to see you soon");
    public $thx = array("Thanks", "Thank you", "Many thanks");
    public $thx2 = array("Thanks", "Thank you", "Many thanks");
    public $lol = array("is rolling on the floor, laughing his *ss off", "Lo0o0ol", "is having a lot of laugh", "is laughing", "is laughing out loud", "xD", "That is just sooo funny!", "Hahahaha", "Hehehe", "lol", "heh");
    public $lol2 = array("is rolling on the floor, laughing his *ss off because of", "Lo0o0ol", "is having a lot of laugh", "is laughing loud", "is laughing out loud thanks to", "xD", "Lulz", "That is just sooo funny", "you're making me laugh");
    public $brb = array("Be Right Back!", "Back in a sec...", "One moment, please...", "I'll be back!");
    public $brb2 = array("Be Right Back", "Back in a sec...", "One moment, please...", "I'll be back", "Please wait, i'll be right back");
    public $afk = array("Away From Keyboard", "AFK, Letting my game spec itself for a moment", "Away from keyboard: I'll be speccing, but i'm not here so don't panic");
    public $afk2 = array("Away From Keyboard", "AFK, Letting my game spec itself for a moment", "Away from keyboard: I'll be speccing, but i'm not here so don't panic");
    public $gg = array("Good Game", "Great Game");
    public $gg2 = array("Good Game", "Great Game");
    public $nl = array("Nice one!", "Well driven, mate!", "Nice Line!", "You're a Pro!", "Very impressing!");
    public $nl2 = array("Nice one!", "Well driven, mate!", "Nice Line!", "You're a Pro!", "Very impressing!");
