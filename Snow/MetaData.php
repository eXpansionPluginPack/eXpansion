...
class MetaData extends \ManiaLivePlugins\eXpansion\Core\types\config\MetaData
{
	...
	public function onBeginLoad()
	{
		...
		$this->setGroups(array('Widgets'));
                ...
                $var = new \ManiaLivePlugins\eXpansion\Core\types\config\types\String("texture", "texture url", $config, false, false);
                $var->setDefaultValue("http://reaby.kapsi.fi/ml/xmas/snowflake2.png");
                $this->registerVariable($var);

                $var = new \ManiaLivePlugins\eXpansion\Core\types\config\types\BoundedInt("particleCount", "Particles count", $config, false, false);
