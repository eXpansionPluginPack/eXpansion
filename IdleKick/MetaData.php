...
class MetaData extends \ManiaLivePlugins\eXpansion\Core\types\config\MetaData
{
    ...
    public function onBeginLoad()
    {
        ...
        $var = new \ManiaLivePlugins\eXpansion\Core\types\config\types\TypeFloat(
            "idleMinutes",
            "Define here minutes after Idlekick should be performed ?",
            $config,
            false,
            false
        );
        ...
        $var = new \ManiaLivePlugins\eXpansion\Core\types\config\types\Boolean(
            "idleKickReally",
            "Really kick the player from server ?",
            $config,
            false,
            false
        );
